...
@Singleton
class FakeUsernameGenerator @Inject constructor() : UsernameGenerator {

    var result: String = "fake-username"

    override suspend fun generateUsername(config: UsernameConfig): String = result
