...
internal data class HomeDrawerState(
    ...
    internal val vaultFolderAtLimit: Set<ShareId>,
    internal val canCreateFolderShareIds: Set<ShareId>,
    internal val canCreateFolderNeedsUpgradeShareIds: Set<ShareId>,
    ...
    internal companion object {
        ...
        internal val Initial: HomeDrawerState = HomeDrawerState(
            ...
            vaultFolderAtLimit = emptySet(),
            canCreateFolderShareIds = emptySet(),
            canCreateFolderNeedsUpgradeShareIds = emptySet(),
