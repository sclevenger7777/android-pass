...
@Composable
internal fun GenerateUsernameBottomSheetContent(
    ...
    Column(
        ...
        GenerateUsernameBottomSheetTitle(
            onRegenerate = { onEvent(GenerateUsernameUiEvent.OnRegenerate) }
        )
...
internal class ThemeAndUsernameUiStateProvider :
    ThemePairPreviewProvider<GenerateUsernameUiState>(GenerateUsernameStatePreviewProvider())

@[Preview Composable]
internal fun GenUsernameBottomSheetContentPreview(
    @PreviewParameter(ThemeAndUsernameUiStateProvider::class) input: Pair<Boolean, GenerateUsernameUiState>
) {
