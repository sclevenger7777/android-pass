...
@Composable
fun GenerateUsernameBottomSheetTitle(modifier: Modifier = Modifier, onRegenerate: () -> Unit) {
    Box(
        modifier = modifier.fillMaxWidth()
    ) {
        Text(
            modifier = Modifier.align(Alignment.Center),
            text = stringResource(id = R.string.generate_username_title),
        ...
        CircleIconButton(
            ...
            Icon(
                ...
                contentDescription = stringResource(R.string.generate_username_button_regenerate),
...
@Preview
@Composable
fun GenerateUsernameBottomSheetTitlePreview(@PreviewParameter(ThemePreviewProvider::class) isDark: Boolean) {
    PassTheme(isDark = isDark) {
        Surface {
            GenerateUsernameBottomSheetTitle(onRegenerate = {})
        }
    }
}
