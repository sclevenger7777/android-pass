...
class FakeOpenProtonApp(
    private var defaultResult: OpenResult = OpenResult.OpenedApp
) : OpenProtonApp {

    val invocations = mutableListOf<ProtonApp>()

    fun setResult(result: OpenResult) {
