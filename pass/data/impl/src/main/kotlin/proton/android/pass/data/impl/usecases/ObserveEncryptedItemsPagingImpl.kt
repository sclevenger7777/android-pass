...
class ObserveEncryptedItemsPagingImpl @Inject constructor(
    private val syncStatusRepository: ItemSyncStatusRepository,
    private val itemRepository: ItemRepository,
    private val observeCurrentUser: ObserveCurrentUser
) : ObserveEncryptedItemsPaging {
    ...
    ): Flow<PagingData<ItemEncrypted>> = syncStatusRepository.observeSyncState()
    ...
    private fun observeItems(
        ...
        itemFlags: Map<ItemFlag, Boolean>,
        includeHidden: Boolean
    ): Flow<PagingData<ItemEncrypted>> = itemRepository.observeEncryptedItemsPaging(
        userId = userId,
