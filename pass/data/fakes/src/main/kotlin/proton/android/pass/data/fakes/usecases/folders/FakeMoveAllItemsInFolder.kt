...
@Singleton
class FakeMoveAllItemsInFolder @Inject constructor() : MoveAllItemsInFolder {
    ...
    override suspend fun invoke(
        ...
        memory.add(Payload(shareId, folderId, destShareId, destFolderId))
        result.getOrThrow()
    }
